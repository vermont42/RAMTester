...
The Excel spreadsheet and the code for the RAM-tester app are available in this repo. I initially wrote the code to allow triggering of specific tests via buttons, but I changed it to trigger tests in viewDidAppear: in order to prevent Instruments from measuring the time it took me to tap a button.
